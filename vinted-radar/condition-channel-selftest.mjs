...
assert.match(routing, /DAN_CONDITION_CHANNEL_ROUTING_V4/);
assert.match(routing, /newWithoutTagsWebhook/);
assert.match(routing, /newWithTagsWebhook/);
assert.match(routing, /veryGoodWebhook/);
assert.match(routing, /bot === 'clothing'/);
assert.match(routing, /return primaryWebhook/);
...
assert.match(routing, /selectDiscordWebhook\(bot, alert, webhook, newWithoutTagsWebhook, newWithTagsWebhook, veryGoodWebhook\)/);
assert.match(routing, /selectDiscordWebhook\(bot, pending\.alert, webhook, newWithoutTagsWebhook, newWithTagsWebhook, veryGoodWebhook\)/);
